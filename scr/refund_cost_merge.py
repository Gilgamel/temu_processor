...
folder_config = [
    # Sixale
    {
        ...
        "output_file": "C:\\Users\\vuser\\Documents\\Monthly Report\\Monthly Channel Profit\\Temu Ventchoice\\sixale outfitters account\\processed\\temu_sixale_refund_output.xlsx"
    },
...
def standardize_columns(df):
    ...
    """
    # Define the mapping of terms to replace
    replacements = {
